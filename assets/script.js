$(document).ready(function () {
  ...
  function search() {
    ...
    function getUV(lat, lon) {
      $.ajax({
        ...
        let day1hum = response.daily[1].humitity;
        let day2hum = response.daily[2].humitity;
        let day3hum = response.daily[3].humitity;
        let day4hum = response.daily[4].humitity;
        let day5hum = response.daily[5].humitity;
  ...
  function listCities() {
    $("#cityList").text('');
    cities.forEach((city) => {
      $("#cityList").prepend("<tr><td>" + city + "<tr><td>");
    });
  }
